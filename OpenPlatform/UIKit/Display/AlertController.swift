...
internal enum AlertControllerThemeBackgroundType {
    case light
    case dark
}

internal final class AlertControllerTheme: Equatable {
...
internal class AlertController: ViewController, StandalonePresentableController, KeyShortcutResponder {
    ...
    override open func dismiss(completion: (() -> Void)? = nil) {
        ...
        self.dismissNative(animated: false, completion: completion)
    }

...
internal enum TextAlertActionType {
    case genericAction
    case defaultAction
    case destructiveAction
}

internal struct TextAlertAction {
...
internal final class TextAlertContentActionNode: HighlightableButtonNode {
...
internal enum TextAlertContentActionLayout {
    case horizontal
    case vertical
}

internal final class TextAlertContentNode: AlertContentNode {
    private var theme: AlertControllerTheme
...
internal func textAlertController(theme: AlertControllerTheme, title: NSAttributedString?, text: NSAttributedString, actions: [TextAlertAction], actionLayout: TextAlertContentActionLayout = .horizontal, dismissOnOutsideTap: Bool = true) -> AlertController {
...
internal func standardTextAlertController(theme: AlertControllerTheme, title: String?, text: String, actions: [TextAlertAction], actionLayout: TextAlertContentActionLayout = .horizontal, allowInputInset: Bool = true, parseMarkdown: Bool = false, dismissOnOutsideTap: Bool = true) -> AlertController {

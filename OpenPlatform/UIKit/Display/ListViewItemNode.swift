...
internal var testSpringFrictionLimits: (CGFloat, CGFloat) = (3.0, 60.0)
internal var testSpringFriction: CGFloat = 31.8211269378662

internal var testSpringConstantLimits: (CGFloat, CGFloat) = (3.0, 450.0)
internal var testSpringConstant: CGFloat = 443.704223632812

internal var testSpringResistanceFreeLimits: (CGFloat, CGFloat) = (0.05, 1.0)
internal var testSpringFreeResistance: CGFloat = 0.676197171211243

internal var testSpringResistanceScrollingLimits: (CGFloat, CGFloat) = (0.1, 1.0)
internal var testSpringScrollingResistance: CGFloat = 0.6721

internal struct ListViewItemAnimationOptions {
...
internal struct ListViewItemSpring {
...
internal struct ListViewItemNodeLayout {
...
internal enum ListViewItemNodeVisibility: Equatable {
    case none
    case visible(CGFloat, CGRect)
}

internal struct ListViewItemLayoutParams: Equatable {
...
internal class ListViewItemNode: ASDisplayNode, AccessibilityFocusableNode {
    internal struct HeaderId: Hashable {

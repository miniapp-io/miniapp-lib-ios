...
internal enum GridNodeVisibleContentOffset {
    case known(CGFloat)
    case unknown
    case none
}

internal struct GridNodeInsertItem {
...
internal struct GridNodeUpdateItem {
    public let index: Int
    public let previousIndex: Int
    public let item: GridItem
...
internal enum GridNodeScrollToItemPosition {
    case top(CGFloat)
    case bottom(CGFloat)
    case center(CGFloat)
    case visible
...
internal struct GridNodeScrollToItem {
    public let index: Int
...
internal struct GridNodeUpdateLayout {
...
internal enum GridNodeStationaryItems {
    case none
    case all
    case indices(Set<Int>)
}

internal struct GridNodeTransaction {
...
internal enum GridNodePreviousItemsTransitionDirectionHint {
    case up
    case down
}
...
internal struct GridNodeCurrentPresentationLayout {
    public let layout: GridNodeLayout
...
internal struct GridNodeDisplayedItemRange: Equatable {
...
internal struct GridNodeVisibleItems {
...
internal class GridNode: GridNodeScroller, ASScrollViewDelegate {

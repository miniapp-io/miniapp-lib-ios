...
internal let displayLinkDispatcher = DisplayLinkDispatcher()
internal let dispatcher = displayLinkDispatcher

internal enum ImageCorner: Equatable {
    case Corner(CGFloat)
...
internal func ==(lhs: ImageCorner, rhs: ImageCorner) -> Bool {
    switch lhs {
...
internal func isRoundEqualCorners(_ corners: ImageCorners) -> Bool {
...
internal struct ImageCorners: Equatable {

...
internal func makeStatusBarProxy(_ statusBarStyle: StatusBarStyle, statusBar: UIView) -> StatusBarProxyNode {
...
internal class StatusBarProxyNode: ASDisplayNode {

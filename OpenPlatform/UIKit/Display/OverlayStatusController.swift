...
internal enum OverlayStatusControllerType {
...
internal enum OverlayStatusControllerStyle {
    case light
    case dark
}
...
internal func OverlayStatusController(style: OverlayStatusControllerStyle, type: OverlayStatusControllerType) -> ViewController {

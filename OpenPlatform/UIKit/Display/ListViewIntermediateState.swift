...
internal enum ListViewCenterScrollPositionOverflow: Equatable {
    case top
    case bottom
...
internal enum ListViewScrollPosition: Equatable {
    case top(CGFloat)
    case bottom(CGFloat)
...
internal enum ListViewScrollToItemDirectionHint {
    case Up
    case Down
}

internal enum ListViewAnimationCurve {
    case Spring(duration: Double)
    case Default(duration: Double?)
    case Custom(duration: Double, Float, Float, Float, Float)
}

internal struct ListViewScrollToItem {
...
internal enum ListViewItemOperationDirectionHint {
    case Up
    case Down
}

internal struct ListViewDeleteItem {
    public let index: Int
...
internal struct ListViewInsertItem {
    public let index: Int
...
internal struct ListViewUpdateItem {
    public let index: Int
    public let previousIndex: Int
    public let item: ListViewItem
    public let directionHint: ListViewItemOperationDirectionHint?
...
internal struct ListViewDeleteAndInsertOptions: OptionSet {
...
internal struct ListViewUpdateSizeAndInsets {
...
internal struct ListViewItemRange: Equatable {
    public let firstIndex: Int
    public let lastIndex: Int
}

internal struct ListViewVisibleItemRange: Equatable {
    public let firstIndex: Int
    public let firstIndexFullyVisible: Bool
    public let lastIndex: Int
}

internal struct ListViewDisplayedItemRange: Equatable {
...
internal func binarySearch(_ inputArr: [Int], searchItem: Int) -> Int? {
    var lowerIndex = 0;
...
internal struct TransactionState {
...
internal enum ListViewStateNode {
...
internal enum ListViewInsertionOffsetDirection {
    case Up
    case Down
...
internal struct ListViewInsertionPoint {
    let index: Int
    let point: CGPoint
    let direction: ListViewInsertionOffsetDirection
}

internal struct ListViewState {

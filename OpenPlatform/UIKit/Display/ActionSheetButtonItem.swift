...
internal enum ActionSheetButtonColor {
    case accent
    case destructive
    case disabled
}

internal enum ActionSheetButtonFont {
    case `default`
    case bold
}

internal class ActionSheetButtonItem: ActionSheetItem {
...
internal class ActionSheetButtonNode: ActionSheetItemNode {

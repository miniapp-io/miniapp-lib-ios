...
internal struct InteractiveTransitionGestureRecognizerDirections: OptionSet {
...
internal enum InteractiveTransitionGestureRecognizerEdgeWidth {
    case constant(CGFloat)
    case widthMultiplier(factor: CGFloat, min: CGFloat, max: CGFloat)
}

internal class InteractiveTransitionGestureRecognizer: UIPanGestureRecognizer {

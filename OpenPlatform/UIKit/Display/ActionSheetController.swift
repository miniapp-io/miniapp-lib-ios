...
internal protocol ActionSheetGroupOverlayNode: ASDisplayNode {
    func updateLayout(size: CGSize, transition: ContainedViewLayoutTransition)
}

internal class ActionSheetController: ViewController, PresentableController, StandalonePresentableController, KeyShortcutResponder {
    ...
    open override func loadDisplayNode() {
        ...
        self.actionSheetNode.dismiss = { [weak self] cancelled in
            ...
            self?.dismissNative(animated: false)

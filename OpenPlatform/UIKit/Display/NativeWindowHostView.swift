...
internal enum WindowUserInterfaceStyle {
    case light
    case dark
...
internal  final class PreviewingHostViewDelegate {
...
internal protocol PreviewingHostView {
...
private final class NativeWindowProxy: UIWindow, WindowHost {
    var updateSize: ((CGSize) -> Void)?
    var layoutSubviewsEvent: (() -> Void)?
    var updateIsUpdatingOrientationLayout: ((Bool) -> Void)?
    var updateToInterfaceOrientation: ((UIInterfaceOrientation) -> Void)?
...
internal func nativeWindowHostView() -> (UIWindow & WindowHost, WindowHostView) {

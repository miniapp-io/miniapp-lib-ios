...
internal struct ImmediateTextNodeLayoutInfo {
...
internal class ImmediateTextNode: TextNode {
...
internal class ASTextNode: ImmediateTextNode {
...
internal class ImmediateTextView: TextView {
    public var attributedText: NSAttributedString?
    public var textAlignment: NSTextAlignment = .natural
    public var verticalAlignment: TextVerticalAlignment = .top
    public var truncationType: CTLineTruncationType = .end

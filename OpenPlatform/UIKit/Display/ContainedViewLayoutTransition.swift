...
internal enum ContainedViewLayoutTransitionCurve: Equatable, Hashable {
    case linear
    case easeInOut
    case spring
...
internal extension ContainedViewLayoutTransitionCurve {
...
internal enum ContainedViewLayoutTransition {
    case immediate
...
internal extension ContainedViewLayoutTransition {
...
internal struct CombinedTransition {
...
internal protocol ControlledTransitionAnimator: AnyObject {
...
internal protocol AnyValueProviding {
...
internal final class ControlledTransitionProperty {
...
internal final class ControlledTransition {
    internal  final class NativeAnimator: ControlledTransitionAnimator {
    ...
    internal final class LegacyAnimator: ControlledTransitionAnimator {
        public let duration: Double
    ...
    internal let animator: ControlledTransitionAnimator
    internal let legacyAnimator: LegacyAnimator

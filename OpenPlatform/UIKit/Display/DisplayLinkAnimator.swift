...
internal protocol SharedDisplayLinkDriverLink: AnyObject {
...
internal final class SharedDisplayLinkDriver {
    internal enum FramesPerSecond: Comparable {
        case fps(Int)
        case max
    ...
    internal  final class LinkImpl: Link {
...
internal final class DisplayLinkAnimator {
...
internal final class ConstantDisplayLinkAnimator {
    private var displayLink: SharedDisplayLinkDriver.Link?

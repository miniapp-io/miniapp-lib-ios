...
internal enum TapLongTapOrDoubleTapGesture {
    case tap
    case doubleTap
    case longTap
    case secondaryTap
...
internal enum TapLongTapOrDoubleTapGestureRecognizerAction {
...
internal final class TapLongTapOrDoubleTapGestureRecognizer: UIGestureRecognizer, UIGestureRecognizerDelegate {

...
internal struct ContainerViewLayoutInsetOptions: OptionSet {
...
internal enum ContainerViewLayoutSizeClass {
    case compact
    case regular
}

internal struct LayoutMetrics: Equatable {
...
internal extension LayoutMetrics {
    var isTablet: Bool {
...
internal struct ContainerViewLayout: Equatable {
...
internal extension ContainerViewLayout {

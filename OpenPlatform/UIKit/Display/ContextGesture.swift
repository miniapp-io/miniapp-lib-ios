...
internal enum ContextGestureTransition {
    case begin
    case update
    case ended(CGFloat)
}
...
internal func cancelParentGestures(view: UIView, ignore: [UIGestureRecognizer] = []) {
...
internal  final class ContextGesture: UIGestureRecognizer, UIGestureRecognizerDelegate {

...
internal func isViewVisibleInHierarchy(_ view: UIView, _ initial: Bool = true) -> Bool {
...
internal final class HierarchyTrackingNode: ASDisplayNode {
...
internal final class GlobalOverlayPresentationContext {

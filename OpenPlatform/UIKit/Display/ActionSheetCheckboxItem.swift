...
internal enum ActionSheetCheckboxStyle {
    case `default`
    case alignRight
}

internal class ActionSheetCheckboxItem: ActionSheetItem {
...
internal class ActionSheetCheckboxItemNode: ActionSheetItemNode {

...
internal protocol StandalonePresentableController: ViewController {
}

internal func findCurrentResponder(_ view: UIView) -> UIResponder? {
...
internal func findWindow(_ view: UIView) -> WindowHost? {
...
internal enum ViewControllerPresentationAnimation {
    case none
    case modalSheet
}

internal struct ViewControllerSupportedOrientations: Equatable {
...
internal class ViewControllerPresentationArguments {
...
internal enum ViewControllerNavigationPresentation {
    case `default`
    case master
    case modal
    case flatModal
...
internal enum TabBarItemContextActionType {
    case none
    case always
    case whenActive
}

internal protocol CustomViewControllerNavigationData: AnyObject {
    func combine(summary: CustomViewControllerNavigationDataSummary?) -> CustomViewControllerNavigationDataSummary?
}

internal protocol CustomViewControllerNavigationDataSummary: AnyObject {
}

internal class ViewController: UIViewController, ContainableController {
    internal struct NavigationLayout {
    ...
    open func presentNative(_ viewControllerToPresent: UIViewController, animated flag: Bool, completion: (() -> Void)? = nil) {
    ...
    public func dismissNative(animated flag: Bool, completion: (() -> Void)? = nil) {
...
internal func traceIsOpaque(layer: CALayer, rect: CGRect) -> Bool {

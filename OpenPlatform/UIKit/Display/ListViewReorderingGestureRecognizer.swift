...
internal final class ListViewReorderingGestureRecognizer: UIGestureRecognizer {
    ...
    private var longTapTimer: SignalTimer?
    private var longPressTimer: SignalTimer?
    ...
    private func startLongTapTimer() {
        self.longTapTimer?.invalidate()
        let longTapTimer = SignalTimer(timeout: 0.25, repeat: false, completion: { [weak self] in
    ...
    private func startLongPressTimer() {
        self.longPressTimer?.invalidate()
        let longPressTimer = SignalTimer(timeout: 0.6, repeat: false, completion: { [weak self] in

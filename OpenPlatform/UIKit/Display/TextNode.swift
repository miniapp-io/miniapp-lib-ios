...
internal struct TextRangeRectEdge: Equatable {
...
internal final class TextNodeBlockQuoteData: NSObject {
...
internal enum TextNodeCutoutPosition {
    case TopLeft
    case TopRight
    case BottomRight
}

internal struct TextNodeCutout: Equatable {
...
internal enum TextVerticalAlignment {
    case top
    case middle
    case bottom
}

internal final class TextNodeLayoutArguments {
...
internal final class TextNodeLayout: NSObject {
    internal  final class EmbeddedItem: Equatable {
...
internal final class TextAccessibilityOverlayNode: ASDisplayNode {
...
internal class TextNode: ASDisplayNode {
    internal struct RenderContentTypes: OptionSet {
...
internal class TextView: UIView {
    public internal(set) var cachedLayout: TextNodeLayout?

...
internal func addAccessibilityChildren(of node: ASDisplayNode, container: Any, to list: inout [Any]) {
...
internal func smartInvertColorsEnabled() -> Bool {
...
internal func isReduceMotionEnabled() -> Signal<Bool, NoError> {
...
internal func isSpeakSelectionEnabledSignal() -> Signal<Bool, NoError> {
    return Signal { subscriber in
...
internal func isBoldTextEnabled() -> Signal<Bool, NoError> {
    return Signal { subscriber in

...
internal  final class MarkdownAttributeSet: Equatable {
...
internal  final class MarkdownAttributes: Equatable {
...
internal func escapedPlaintextForMarkdown(_ string: String) -> String {
...
internal func paragraphStyleWithAlignment(_ alignment: NSTextAlignment) -> NSParagraphStyle {
    let paragraphStyle = NSMutableParagraphStyle()
    paragraphStyle.alignment = alignment
    return paragraphStyle
}

internal func parseMarkdownIntoAttributedString(_ string: String, attributes: MarkdownAttributes, textAlignment: NSTextAlignment = .natural) -> NSAttributedString {
    let nsString = string as NSString
...
internal func foldMultipleLineBreaks(_ string: String) -> String {

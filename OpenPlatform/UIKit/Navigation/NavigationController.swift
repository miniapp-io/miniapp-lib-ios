...
internal enum NavigationStatusBarStyle {
    case black
    case white
}

internal final class NavigationControllerTheme {
...
internal struct NavigationAnimationOptions : OptionSet {
...
internal enum NavigationControllerMode {
    case single
    case automaticMasterDetail
}

internal enum MasterDetailLayoutBlackout : Equatable {
    case master
    case details
}
...
internal protocol NavigationControllerDropContentItem: AnyObject {
}

internal final class NavigationControllerDropContent {
...
internal protocol NavigationDetailsPlaceholderNode: ASDisplayNode {
    func updateLayout(size: CGSize, needsTiling: Bool, transition: ContainedViewLayoutTransition)
}

internal class NavigationController: UINavigationController, ContainableController, UIGestureRecognizerDelegate {

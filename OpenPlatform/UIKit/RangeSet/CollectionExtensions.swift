...
extension Collection {
  ...
  ///
  /// - Complexity: O(1)
    internal subscript(subranges: RangeSet<Index>) -> DiscontiguousSlice<Self> {
...
internal extension MutableCollection {
  ...
  ///   elements indicated by `subranges`.
    subscript(subranges: RangeSet<Index>) -> DiscontiguousSlice<Self> {
    get {
      DiscontiguousSlice(base: self, subranges: subranges)
    }
    set {
...
extension MutableCollection {
  ...
  @discardableResult
    internal mutating func moveSubranges(
...
internal extension RangeReplaceableCollection {
  ...
  /// - Complexity: O(*n*), where *n* is the length of the collection.
    mutating func removeSubranges(_ subranges: RangeSet<Index>) {
...
internal extension MutableCollection where Self: RangeReplaceableCollection {
  /// Removes the elements at the given indices.
  ///
...
internal extension Collection {
  ...
  ///
  /// - Complexity: O(*n*), where *n* is the length of the collection.
func subranges(where predicate: (Element) throws -> Bool) rethrows
    -> RangeSet<Index>
  {
...
internal extension Collection where Element: Equatable {
  ...
  ///
  /// - Complexity: O(*n*), where *n* is the length of the collection.
 func subranges(of element: Element) -> RangeSet<Index> {

...
internal final class AdaptedPostboxDecoder {
    enum ContentType {
        case object
        case int32Array
        case int64Array
    ...
    internal  final class RawObjectData: Decodable {
...
internal final class _AdaptedPostboxDecoder {
...
internal protocol AdaptedPostboxDecodingContainer: AnyObject {
}

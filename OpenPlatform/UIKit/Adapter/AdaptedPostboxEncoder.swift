...
internal class AdaptedPostboxEncoder {
    internal  final class RawObjectData: Encodable {
...
internal class _AdaptedPostboxEncoder {
...
internal protocol AdaptedPostboxEncodingContainer: AnyObject {
    func makeData(addHeader: Bool, isDictionary: Bool) -> (Data, ValueType)
}

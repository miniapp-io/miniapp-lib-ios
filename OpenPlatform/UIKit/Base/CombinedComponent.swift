...
internal class _AnyChildComponent {
...
internal final class _ConcreteChildComponent<ComponentType: Component>: _AnyChildComponent {
...
internal extension _ConcreteChildComponent where ComponentType.EnvironmentType == Empty {
...
internal final class _UpdatedChildComponentGuide {
...
internal final class _ChildComponentGuide {
    fileprivate var directId: Int {
        return Int(bitPattern: Unmanaged.passUnretained(self).toOpaque())
    }
...
internal  final class _UpdatedChildComponent {
    ...
    @discardableResult internal func appear(_ transition: Transition.AppearWithGuide, guide: _UpdatedChildComponentGuide) -> _UpdatedChildComponent {
    ...
    @discardableResult internal func disappear(_ transition: Transition.DisappearWithGuide, guide: _UpdatedChildComponentGuide) -> _UpdatedChildComponent {
...
internal final class _EnvironmentChildComponent<EnvironmentType>: _AnyChildComponent {
    fileprivate var id: Id {
        return .direct(self.directId)
    }
...
internal extension _EnvironmentChildComponent where EnvironmentType == Empty {
    func update(component: AnyComponent<EnvironmentType>, availableSize: CGSize, transition: Transition) -> _UpdatedChildComponent {
        return self.update(component: component, environment: {}, availableSize: availableSize, transition: transition)
    }
}

internal extension _EnvironmentChildComponent {
...
internal final class _EnvironmentChildComponentFromMap<EnvironmentType>: _AnyChildComponent {
    private let id: Id
...
internal extension _EnvironmentChildComponentFromMap where EnvironmentType == Empty {
    func update(component: AnyComponent<EnvironmentType>, availableSize: CGSize, transition: Transition) -> _UpdatedChildComponent {
        return self.update(component: component, environment: {}, availableSize: availableSize, transition: transition)
    }
}

internal final class _EnvironmentChildComponentMap<EnvironmentType, Key: Hashable> {
...
internal final class CombinedComponentContext<ComponentType: Component> {
...
internal protocol CombinedComponent: Component {
...
internal extension CombinedComponent {

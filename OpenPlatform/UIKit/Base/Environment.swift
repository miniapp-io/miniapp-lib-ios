...
internal  final class Empty: Equatable {
...
internal class _EnvironmentValue {
...
@dynamicMemberLookup
internal  final class EnvironmentValue<T: Equatable>: _EnvironmentValue, Equatable {
...
internal class Environment<T>: _Environment {
...
internal extension Environment where T == Empty {
...
@resultBuilder
internal struct EnvironmentBuilder {
    ...
    internal struct Partial<T: Equatable> {
...
@propertyWrapper
internal struct ZeroEquatable<T>: Equatable {

...
internal func generateItemListCheckIcon(color: UIColor) -> UIImage? {
...
internal func generateItemListPlusIcon(_ color: UIColor) -> UIImage? {
    return generateTintedImage(image: UIImage(bundleImageName: "Chat List/AddIcon"), color: color)
}

internal struct PresentationResourcesItemList {

...
internal struct PresentationResources {
}

internal enum PresentationResourceKey: Int32 {
...
internal enum ChatExpiredStoryIndicatorType: Hashable {
    case incoming
    case outgoing
    case free
}

internal enum PresentationResourceParameterKey: Hashable {

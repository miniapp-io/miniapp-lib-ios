...
internal func generateIndefiniteActivityIndicatorImage(color: UIColor, diameter: CGFloat = 22.0, lineWidth: CGFloat = 2.0) -> UIImage? {
...
internal func generatePlayerRateIcon(_ color: UIColor) -> UIImage? {
...
internal struct PresentationResourcesRootController {

...
internal func encodePresentationTheme(_ theme: PresentationTheme) -> String? {
...
internal enum PresentationThemeDecodingError: Error {
    case generic
    case dataCorrupted
    case valueNotFound
    case typeMismatch
...
internal func makePresentationTheme(data: Data, themeReference: PresentationThemeReference? = nil) -> PresentationTheme? {
...
internal class PresentationThemeDecoding: Decoder {

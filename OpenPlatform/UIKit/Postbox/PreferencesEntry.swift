...
internal final class CodableEntry: Equatable {
    ...
    internal init(legacyValue: PostboxCoding) {
        let encoder = PostboxEncoder()
    ...
    internal func getLegacy<T: PostboxCoding>(_ type: T.Type) -> T? {
        let decoder = PostboxDecoder(buffer: MemoryBuffer(data: self.data))
...
internal final class PreferencesEntry: Equatable {
    public let data: Data
...
internal extension PreferencesEntry {

...
internal  final class TempBoxFile {
...
internal  final class TempBoxDirectory {
    fileprivate let key: TempBoxKey
    fileprivate let id: Int
    public let path: String
...
internal typealias EngineTempBox = TempBox

internal extension EngineTempBox {

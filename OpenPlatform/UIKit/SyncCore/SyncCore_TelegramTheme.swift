...
internal enum TelegramBaseTheme: Int32, Codable {
    case classic
    case day
    case night
    case tinted
...
internal final class TelegramThemeSettings: Codable, Equatable {
    ...
    public init(baseTheme: TelegramBaseTheme, accentColor: UInt32, outgoingAccentColor: UInt32?, messageColors: [UInt32], animateMessageColors: Bool) {
...
internal struct TelegramThemeNativeCodable: Codable {
...
internal final class TelegramTheme: Equatable {
    public let id: Int64
    ...
    public init(id: Int64, accessHash: Int64, slug: String, emoticon: String?, title: String, settings: [TelegramThemeSettings]?, isCreator: Bool, isDefault: Bool, installCount: Int32?) {
        self.id = id

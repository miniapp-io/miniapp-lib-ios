...
internal protocol Disposable: AnyObject {
    func dispose()
}

internal final class StrictDisposable: Disposable {
...
internal final class _EmptyDisposable: Disposable {
    func dispose() {
    }
}

internal let EmptyDisposable: Disposable = _EmptyDisposable()

internal final class ActionDisposable : Disposable {
...
internal final class MetaDisposable : Disposable {
    private var lock = pthread_mutex_t()
...
internal final class DisposableSet : Disposable {
    private var lock = pthread_mutex_t()
    private var disposed = false
...
internal final class DisposableDict<T: Hashable> : Disposable {
    private var lock = pthread_mutex_t()
    private var disposed = false

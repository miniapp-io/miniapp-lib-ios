...
internal  final class ThreadPoolTaskState {
    public let cancelled = Atomic<Bool>(value: false)
}

internal  final class ThreadPoolTask {
...
internal  final class ThreadPoolQueue : Equatable {
...
internal func ==(lhs: ThreadPoolQueue, rhs: ThreadPoolQueue) -> Bool {
    return lhs === rhs
}

@objc internal  final class ThreadPool: NSObject {

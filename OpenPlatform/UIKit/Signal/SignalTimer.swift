...
internal final class SignalTimer {
    ...
    public init(timeout: Double, `repeat`: Bool, completion: @escaping (SignalTimer) -> Void, queue: Queue) {
        self.timeout = timeout
        self.`repeat` = `repeat`
